...
3. Binds a local HTTP proxy on the configured port (default `49156`) that serves both upstreams — Anthropic on the catch-all `/v1`, Gemini Native on the `/v1beta` path-prefix route.
